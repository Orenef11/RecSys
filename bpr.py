...
class BPR(object):
    ...
    def init(self,data):
        ...
        self.item_time_influence_sin_amplitude = np.random.random_sample((self.num_items,1))
        self.item_time_influence_sin_wave_length = np.random.random_sample((self.num_items,1))
        self.item_time_influence_sin_phase = np.random.random_sample((self.num_items,1))
    ...
    def update_factors(self,u,i,j,ui_time,update_u=True,update_i=True):
        ...
        x = self.item_bias[i] - self.item_bias[j] \
            ...
            + self.item_time_influence_sin_amplitude[i] * sin(self.item_time_influence_sin_wave_length[i] * time_diff + self.item_time_influence_sin_phase[i]) \
            - self.item_time_influence_sin_amplitude[j] * sin(self.item_time_influence_sin_wave_length[j] * time_diff + self.item_time_influence_sin_phase[j])
        ...
        d = z * (1 - z) * sin(self.item_time_influence_sin_wave_length[i] * time_diff + self.item_time_influence_sin_phase[i]) - self.bias_regularization * self.item_time_influence_sin_amplitude[i]
        self.item_time_influence_sin_amplitude[i] += self.learning_rate * d
        d = -z * (1 - z) * sin(self.item_time_influence_sin_wave_length[j] * time_diff + self.item_time_influence_sin_phase[j]) - self.bias_regularization * self.item_time_influence_sin_amplitude[j]
        self.item_time_influence_sin_amplitude[j] += self.learning_rate * d

        # update item_time_influence_sin_wave_length:
        d = z * (1 - z) * self.item_time_influence_sin_amplitude[i] * time_diff * cos(self.item_time_influence_sin_wave_length[i] * time_diff + self.item_time_influence_sin_phase[i]) - self.bias_regularization * self.item_time_influence_sin_wave_length[i]
        self.item_time_influence_sin_wave_length[i] += self.learning_rate * d
        d = -z * (1 - z) * self.item_time_influence_sin_amplitude[j] * time_diff * cos(self.item_time_influence_sin_wave_length[j] * time_diff + self.item_time_influence_sin_phase[j]) - self.bias_regularization * self.item_time_influence_sin_wave_length[j]
        self.item_time_influence_sin_wave_length[j] += self.learning_rate * d

        # update item_time_influence_sin_phase:
        d = z * (1 - z) * self.item_time_influence_sin_amplitude[i] * cos(self.item_time_influence_sin_wave_length[i] * time_diff + self.item_time_influence_sin_phase[i]) - self.bias_regularization * self.item_time_influence_sin_phase[i]
        self.item_time_influence_sin_phase[i] += self.learning_rate * d
        d = -z * (1 - z) * self.item_time_influence_sin_amplitude[j] * cos(self.item_time_influence_sin_wave_length[j] * time_diff + self.item_time_influence_sin_phase[j]) - self.bias_regularization * self.item_time_influence_sin_phase[j]
        self.item_time_influence_sin_phase[j] += self.learning_rate * d
